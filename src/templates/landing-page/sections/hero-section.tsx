...
export function HeroSection(){
  ...
  return(
    <section className="container relative flex items-center justify-center mt-16 bg-gray-700">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 min-h-80 md:h-144 items-center">
        <div className="flex flex-col tems-center justify-center gap-4 md:items-start lg:items-start">
