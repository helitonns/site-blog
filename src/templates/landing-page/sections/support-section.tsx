...
export function SupportSection(){
  ...
  return(
    <section className="relative pb-8 md:py-10 bg-gray-700 mt-40 mb-40">
      ...
      <div className="container flex flex-col items-center gap-12 relative">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="flex flex-col text-left gap-2 rounded-lg p-6 md:p-12 bg-blue-400">
            <div className="flex w-12 h-12 items-center justify-center rounded-lg bg-blue-300 mb-4">
            ...
            <p className="text-body-sm text-gray-200">Adicione sua logo, favicon, cores no seu catálogo e tenha tudo com com a sua cara.</p>
          </div>
          
          <div className="flex flex-col text-left gap-2 rounded-lg p-6 md:p-12 bg-cyan-300">
            <div className="flex w-12 h-12 items-center justify-center rounded-lg bg-cyan-200 mb-4">
